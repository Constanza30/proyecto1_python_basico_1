...
Este proyecto tiene como objetivo evaluar la calidad de una muestra de datos de usuarios, identificar inconsistencias y aplicar técnicas básicas de limpieza y preparación de datos utilizando **Python**.
...
2. `user_name`: Nombre completo del usuario  
3. `user_age`: Edad del usuario  
4. `fav_categories`: Lista de categorías favoritas  
5. `total_spendings`: Lista de montos gastados por categoría  
